  ...
  const mainServices = [
    {
      ...
      description: 'Strategic Meta, Google & LinkedIn advertising campaigns that drive targeted traffic and maximize ROI for your business.',
      features: ['Meta Ads (Facebook & Instagram)', 'Google Ads (Search & Display)', 'LinkedIn B2B Campaigns', 'Retargeting Strategies'],
      stat: '400%',
    ...
    },
    {
      ...
      description: 'Automated email campaigns and WhatsApp marketing that nurture leads and boost conversions effectively.',
      features: ['Email Marketing Automation', 'WhatsApp Business Integration', 'WhatsApp Store Setup', 'Lead Nurturing Sequences'],
      stat: '35%',
      statLabel: 'Open Rate',
    },
    {
      icon: Video,
      title: 'CONTENT & MEDIA',
      description: 'Professional video production, podcast editing, and social media management that captivates your audience.',
      features: ['Video Marketing', 'Podcast Editing', 'Social Media Management', 'Content Strategy'],
      stat: '500K+',
    ...
    },
    {
      ...
      description: 'Custom website design with intuitive UI/UX, responsive layouts, and SEO optimization for maximum visibility.',
      features: ['Custom Website Design', 'UI/UX Development', 'SEO Optimization', 'Performance Analytics'],
      stat: '100%',
    ...
    },
    {
      ...
      features: ['Product Page Design', 'Shopping Cart Integration', 'Payment Gateway Setup', 'Inventory Management'],
      stat: '₹50L+',
    ...
    },
    {
      ...
      description: 'Unique logos, brand identity kits, marketing collaterals, and social media creatives that stand out.',
      features: ['Logo & Brand Identity', 'Marketing Collaterals', 'Social Media Creatives', 'Print Design'],
      stat: '200+',
                   ...
                   <CardContent className="p-8">
                    <div className="flex items-start justify-between mb-6">
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-muted-foreground uppercase tracking-wide">Brands Created</div>
                      </div>
                    </div>
                    <h3 className="text-2xl font-bold text-foreground mb-3 group-hover:text-primary transition-colors">
                      GRAPHIC DESIGN
                    </h3>
                    <p className="text-muted-foreground mb-6">Unique logos, brand identity kits, marketing collaterals, and social media creatives that make your brand stand out.</p>
                    <ul className="grid grid-cols-2 gap-2">
                      {['Logo Design', 'Brand Identity', 'Marketing Collaterals', 'Social Creatives'].map((feature, i) => (
                        <li key={i} className="flex items-center gap-2 text-sm text-muted-foreground">
                          <CheckCircle2 className="w-4 h-4 text-primary flex-shrink-0" />
                          {feature}
                        </li>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Every campaign is backed by analytics and insights</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <Target className="w-5 h-5 text-primary mt-0.5" />
                        <div>
                          <h4 className="font-semibold text-foreground">Local Business Focus</h4>
                          <p className="text-sm text-muted-foreground">Specialized in helping micro and small businesses scale</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">160+ successful projects with 90% client satisfaction</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
