  ...
  const mainServices = [
    {
      ...
      description: 'Build a loyal community and boost brand awareness with strategic organic content, engagement, and consistent posting.',
      features: ['Content Calendar Strategy', 'Community Management', 'Reels & Short-form Video', 'Growth Analytics'],
      stat: '3x',
    ...
    },
    {
      icon: Video,
      title: 'CONTENT & MEDIA',
      description: 'Professional video production and podcast editing that tells your brand story and captivates your audience.',
      features: ['Video Marketing', 'Podcast Editing', 'Ad Creatives Production', 'Content Strategy'],
      stat: '500K+',
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-7xl">
          <div className="grid gap-6">
            ...
            {/* Row 1: Top 2 Priority (Social Media & Paid Ads) */}
            ...
            {/* Row 2: Next 3 Services (Email, Content, Web Dev) */}
            ...
            {/* Row 3: E-Commerce & Graphic Design */}
            <div className="grid md:grid-cols-2 gap-6">
