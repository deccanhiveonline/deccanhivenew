...
export default function BlogPost2() {
  ...
  return (
    <>
      <ArticleSchema headline={post.title} description={post.excerpt} image="https://deccanhive.com/logo2.webp" datePublished={post.date} authorName={post.author} url="https://deccanhive.com/blog/optimize-google-ads-roi" />
      <BreadcrumbSchema items={[{ name: 'Home', url: 'https://deccanhive.com' }, { name: 'Blog', url: 'https://deccanhive.com/blog' }, { name: post.title, url: 'https://deccanhive.com/blog/optimize-google-ads-roi' }]} />
